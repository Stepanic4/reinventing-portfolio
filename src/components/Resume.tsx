...
export const Resume = () => {
  ...
  return (
    <div className="resume-page-container w-full flex flex-col items-center py-10 px-4 print:p-0 print:m-0">
      {/* КНОПКА ДЛЯ ДЕСКТОПА (>= 1300px) - Sticky сверху справа */}
      <div className="sticky top-6 w-full max-w-[210mm] z-40 mb-6 hidden min-[1300px]:flex justify-end print:hidden">
        <button
      ...
      {/* ОСНОВНОЙ А4 */}
      <div className="resume-sheet w-full max-w-[210mm] min-h-[296mm] bg-white dark:bg-slate-900 shadow-2xl print:shadow-none print:m-0 print:w-full flex flex-col overflow-hidden text-slate-900 transition-colors duration-500">
        <div className="h-2 w-full bg-gradient-to-r from-blue-600 via-yellow-400 to-red-500 print:h-1"></div>

        <div className="p-6 md:p-10 flex-grow print:p-8">
          {/* Header */}
          <header className="flex flex-col md:flex-row justify-between items-start mb-8 border-b border-slate-100 dark:border-slate-800 pb-8 print:mb-6 print:border-slate-200 gap-6 md:gap-0">
            <div className="flex items-center gap-6">
              <div className="w-24 h-24 shrink-0 rounded-full overflow-hidden border-2 border-slate-100 shadow-sm print:w-20 print:h-20">
                <img
                  src="/avatar.jpg"
                  alt="Ivan Zolotukhin"
                  ...
                  onError={(e) => {
                    e.currentTarget.src =
                      "https://ui-avatars.com/api/?name=IZ&background=020617&color=fff&size=128";
                  }}
                />
              </div>
              <div>
                <h1 className="text-2xl md:text-3xl font-black tracking-tighter uppercase dark:text-white print:text-black">
                  {t("resume.name")}
                </h1>
              ...
              <section>
                ...
                <div className="space-y-6">
                  <div className="relative pl-4 border-l-2 border-blue-600/20">
                    <div className="flex flex-col sm:flex-row justify-between sm:items-baseline gap-1 sm:gap-0">
                    ...
                    <p className="text-[11px] font-bold text-blue-600 mb-1 uppercase">
                      Simplepin.inc
                    </p>
                ...
                <div className="relative pl-4 border-l-2 border-blue-600/20 space-y-4">
                  <div className="text-xs text-slate-500 dark:text-slate-400">
                    <div className="flex flex-col sm:flex-row justify-between sm:items-start gap-1 sm:gap-0">
                      ...
                      <span className="text-[10px] font-bold text-slate-400 shrink-0 sm:ml-4">
                        2018
                      </span>
                    </div>
                    <p className="italic">Angular 5+</p>
                  </div>
                  <div className="text-xs text-slate-500 dark:text-slate-400">
                    <div className="flex flex-col sm:flex-row justify-between sm:items-start gap-1 sm:gap-0">
                      <span className="font-bold dark:text-white uppercase">
        ...
        <footer className="py-4 mx-6 md:mx-10 text-[10px] text-slate-800 dark:text-slate-600 tracking-widest flex flex-col sm:flex-row justify-between items-center border-t border-slate-100 dark:border-slate-800 print:mb-10 print:border-slate-200 gap-2 sm:gap-0">
          <a
      ...
      {/* КНОПКА ДЛЯ МОБИЛОК (< 1300px) - Статично под листом А4 */}
      <div className="w-full max-w-[210mm] flex min-[1300px]:hidden justify-center mt-8 mb-6 print:hidden">
        <button
          onClick={() => window.print()}
          className="btn-nav-shadow flex items-center gap-2 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md"
        >
